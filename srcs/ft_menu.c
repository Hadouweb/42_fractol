...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/15 07:16:03 by nle-bret          #+#    #+#             */
/*   Updated: 2016/02/15 07:16:07 by nle-bret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_string_put(scn->mlx, scn->win, 20, 10, 0x0EEAFF, "Top          : ^");
	mlx_string_put(scn->mlx, scn->win, 280, 10, 0x0EEAFF, "Bot          : v");
	mlx_string_put(scn->mlx, scn->win, 530, 10, 0x0EEAFF, "Left         : <");
	mlx_string_put(scn->mlx, scn->win, 780, 10, 0x0EEAFF, "Right        : >");
	...
	mlx_string_put(scn->mlx, scn->win, 20, 70, 0x1B76FF,
		"Zoom			 : Mouse wheel");
	mlx_string_put(scn->mlx, scn->win, 530, 70, 0x1B76FF,
		"Dezoom			 : Mouse wheel");
	mlx_string_put(scn->mlx, scn->win, 20, 100, 0x1C3FFD, "Iteration ^ : c");
	mlx_string_put(scn->mlx, scn->win, 530, 100, 0x1C3FFD, "Iteration v	: v");
